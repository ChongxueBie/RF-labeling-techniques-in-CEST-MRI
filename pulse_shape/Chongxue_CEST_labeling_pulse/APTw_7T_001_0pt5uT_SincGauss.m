...
% seq_defs.n_pulses      = 38              ; % number of pulses 38*(0.1+0.005)
...
B0          = seq_defs.B0;          % B0 [T]
B1pa        = 0.435;  % mean sat pulse b1 [uT]
...
for currentOffset = offsets_Hz
    ...
    accumPhase=0;
    for np = 1:n_pulses
        satPulse.phaseOffset = 0; % set accumulated pahse from previous rf pulse
...
filename=[saveDir,'Z-spectrum_sinc_gaussian_no_Phase.mat'];
